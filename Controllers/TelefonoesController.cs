...
namespace personapi_dotnet.Controllers
{
    public class TelefonoesController : Controller
    {
        ...
        public TelefonoesController(PersonasDbContext context)
        {
            _context = context;
        }
        ...
        {
            var personasDbContext = _context.Telefonos.Include(t => t.DuenioNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'PersonasDbContext.Telefonos'  is null.");
            }
            var telefono = await _context.Telefonos.FindAsync(id);
            if (telefono != null)
            {
