...
namespace personapi_dotnet.Controllers
{
    public class ProfesionsController : Controller
    {
        ...
        public ProfesionsController(PersonasDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Profesions != null ? 
                          ...
                          Problem("Entity set 'PersonasDbContext.Profesions'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PersonasDbContext.Profesions'  is null.");
            }
            var profesion = await _context.Profesions.FindAsync(id);
            if (profesion != null)
            {
