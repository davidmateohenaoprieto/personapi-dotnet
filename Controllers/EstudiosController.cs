...
namespace personapi_dotnet.Controllers
{
    public class EstudiosController : Controller
    {
        ...
        public EstudiosController(PersonasDbContext context)
        {
            _context = context;
        }
        ...
        {
            var personasDbContext = _context.Estudios.Include(e => e.CcPerNavigation).Include(e => e.IdProfNavigation);
            return View(await personasDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PersonasDbContext.Estudios'  is null.");
            }
            var estudio = await _context.Estudios.FindAsync(id);
            if (estudio != null)
            {
        ...
        {
          return (_context.Estudios?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
